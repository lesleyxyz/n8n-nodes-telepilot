...
export class TelePilotNodeConnectionManager {
	...
	private TD_DATABASE_PATH_PREFIX = process.env.HOME + "/.n8n/nodes/node_modules/@lesleyxyz/n8n-nodes-telepilot/db"
	private TD_FILES_PATH_PREFIX = process.env.HOME + "/.n8n/nodes/node_modules/@lesleyxyz/n8n-nodes-telepilot/db"
